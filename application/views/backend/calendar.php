...
<link rel="stylesheet" type="text/css"
      href="<?php echo $base_url; ?>/assets/css/bootstrap-multiselect.css" />
<link rel="stylesheet" type="text/css"
      href="<?php echo $base_url; ?>/assets/css/bootstrap-example.css" />
...
<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/prettify.js"></script>
<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/bootstrap-multiselect.js"></script>
...
<!-- Modal -->
<div id="chooseProvidersModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Please select providers below</h4>
            </div>
            <div class="modal-body" id="providers-list">

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" id="btn_chooseProvider">Select</button>
...
<div id="calendar-page">
    <div id="calendar-toolbar">
        <div id="calendar-filter" class="form-group form-inline">
            ...
            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#chooseProvidersModal">Choose Providers</button>
        </div>
        ...
        <div id="calendar-actions">
            <div class="btn-group">
                ...
                <button id="export-schedule" class="btn btn-default"
                        title="<?php echo $this->lang->line('export_schedule'); ?>">
