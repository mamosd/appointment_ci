            ...
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                ...
                <div id="wizard-frame-1" class="wizard-frame">
                    ...
                    <div class="command-buttons">
                        <button type="button" id="button-next-1" class="btn button-next btn-danger"
                                data-step_index="1">
                ...
                <div id="wizard-frame-2" class="wizard-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        ...
                        <button type="button" id="button-next-2" class="btn button-next btn-danger"
                                data-step_index="2">
                            <?php echo $this->lang->line('next'); ?>
                            <span class="glyphicon glyphicon-forward"></span>
                        </button>
                ...
                <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                    <div class="frame-container">
                        ...
                        <div class="frame-content row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="address" class="control-label"><?php echo $this->lang->line('parent_email'); ?></label>
                    ...
                    <div class="command-buttons">
                        ...
                        <button type="button" id="button-next-3" class="btn button-next btn-danger"
                                data-step_index="3">
                            <?php echo $this->lang->line('next'); ?>
                            <span class="glyphicon glyphicon-forward"></span>
                        </button>
                ...
                <div id="frame-footer">
                    ...
                    |
                    <span id="select-language" class="label label-danger">
